    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_cost', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=6, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('unconfirmed', 'Unconfirmed'), ('completed', 'Completed'), ('canceled', 'Canceled'), ('pending', 'Pending'), ('confirmed', 'Confirmed'), ('being prepared', 'Being prepared'), ('ready for pick up', 'Ready for pick up'), ('delivered', 'Delivered'), ('paid for', 'Paid for')], default='Ok', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('waiter', 'Waiter'), ('kitchen_staff', 'Kitchen Staff'), ('manager', 'Manager')], max_length=20)),
                ('staff_id', models.CharField(max_length=50, unique=True)),
        ...
        migrations.AddField(
            model_name='order',
            name='table',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='cafeApi.table'),
        ),
        migrations.AddField(
            model_name='customer',
            name='table',
        ...
        migrations.AddField(
            model_name='order',
            name='waiter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='cafeApi.waiter'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('waiter_call', 'Waiter Call'), ('order_received', 'Order Received'), ('payment', 'Payment'), ('alert', 'Alert'), ('order_ready', 'Order_ready')], max_length=20)),
                ('message', models.TextField(blank=True, default='')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_read', models.BooleanField(default=False)),
                ('kitchen_staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cafeApi.kitchenstaff')),
